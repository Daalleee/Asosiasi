...
itemslist <- read_excel('/Users/asik/Desktop/Assignment-1_Data.xlsx')
...
transactions <- read.transactions('/Users/asik/Desktop/assigment1_itemslist.csv',
                                  format = 'basket', sep = ',')
...
# Get top 10 rules by confidence
